...
#define OAMMEM ((volatile OAMEntry*) 0x7000000)

// Attribute 0
#define ATTR0_REG (0<<8)
#define ATTR0_HIDDEN (2<<8)
#define ATTR0_ALPHA_BLENDING (1<<10)
#define ATTR0_MOSAIC (1<<12)

// Attribute 1
#define ATTR1_NO_FLIP (0)
#define ATTR1_HORIZONTAL_FLIP (1<<12)
#define ATTR1_VERTICAL_FLIP (1<<13)

// Attribute 2
#define PRIORITY(pri) ((pri) << 10) // pri = 0~3

// Graphics
#define SPRITE_PALETTE ((volatile u16*) 0x5000200)

typedef struct {
	u16 tileimg[8192];
} charblock;

#define CHARBLOCKBASE ((volatile charblock*) 0x6000000)

void toggleSpriteMode(u16);
...
#define KEY_JUST_PRESSED(key, buttons, old_buttons) (!KEY_DOWN(key, old_buttons) && KEY_DOWN(key, buttons))
